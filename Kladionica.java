...
static int[][] provjera(int [][]niz){
    ...
    public static void main(String[] args) {
        ...
        //Koji se brojevi ponavljaju
           ...
           System.out.println("Novi broj "+pro[0][3]);
               ...
               for(int l=0;l<6;l++)
           {
               for(int i=0;i<6;i++)
               {
                   if(listic_niz[l]==novi[biranje][i])
                   {
                    brojac++;
            ...
            if(brojac==6)
                    {
                        ...
                        System.out.println("Izgubili ste" + brojac);
